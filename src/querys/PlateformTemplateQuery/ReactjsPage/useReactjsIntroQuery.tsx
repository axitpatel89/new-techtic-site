...
export const useReactjsIntroQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryReactjsBannerSection {
  ...
  const ReactjsIntroData = data.tsPage.flexibleContent.flexibleContent[0];

  return { ReactjsIntroData };
};
