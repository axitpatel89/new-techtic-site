...
export const useNestjsFeaturedWorkQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryNestjsFeaturedWorkSection {
  ...
  const NestjsFeaturedWorkData = data.tsPage.flexibleContent.flexibleContent[5];

  return { NestjsFeaturedWorkData };
};
