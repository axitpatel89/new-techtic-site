...
export const useBigCommerceFeaturedWorkQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryBigCommerceFeaturedWorkSection {
  ...
  const BigCommerceFeaturedWorkData =
    data.tsPage.flexibleContent.flexibleContent[5];

  return { BigCommerceFeaturedWorkData };
};
