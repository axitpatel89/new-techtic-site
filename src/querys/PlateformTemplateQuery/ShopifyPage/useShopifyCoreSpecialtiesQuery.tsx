...
export const useShopifyCoreSpecialtiesQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryShopifyCoreSpecialtiesSection {
  ...
  const ShopifyCoreSpecialtiesData =
    data.tsPage.flexibleContent.flexibleContent[4];

  return { ShopifyCoreSpecialtiesData };
};
