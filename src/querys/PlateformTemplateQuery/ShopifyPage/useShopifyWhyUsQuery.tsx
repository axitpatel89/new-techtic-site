...
export const useShopifyWhyUsQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryShopifyWhyUsSection {
  ...
  const ShopifyWhayUsData = data.tsPage.flexibleContent.flexibleContent[2];

  return { ShopifyWhayUsData };
};
