...
export const useOffshoreWhyUsQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryOffshoreWhyUsSection {
  ...
  const OffshoreWhayUsData = data.tsPage.flexibleContent.flexibleContent[2];

  return { OffshoreWhayUsData };
};
