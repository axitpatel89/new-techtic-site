...
export const useOffshoreIntroQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryOffshoreBannerSection {
  ...
  const OffshoreIntroData = data.tsPage.flexibleContent.flexibleContent[0];

  return { OffshoreIntroData };
};
