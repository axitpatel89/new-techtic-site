...
export const useOffshoreFeaturedThoughtspaceQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryOffshoreFeaturedThoughtspaceSection {
  ...
  const OffshoreThoughtspaceData =
    data.tsPage.flexibleContent.flexibleContent[7];

  return {
    OffshoreThoughtspaceData,
  };
};
