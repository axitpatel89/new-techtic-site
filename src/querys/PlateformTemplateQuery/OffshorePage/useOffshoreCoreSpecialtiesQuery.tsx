...
export const useOffshoreCoreSpecialtiesQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryOffshoreCoreSpecialtiesSection {
  ...
  const OffshoreCoreSpecialtiesData =
    data.tsPage.flexibleContent.flexibleContent[4];

  return { OffshoreCoreSpecialtiesData };
};
