...
export const useKotlinIntroQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryKotlinBannerSection {
  ...
  const KotlinIntroData = data.tsPage.flexibleContent.flexibleContent[0];

  return { KotlinIntroData };
};
