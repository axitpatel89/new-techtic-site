...
export const useKotlinFeaturedWorkQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryKotlinFeaturedWorkSection {
  ...
  const KotlinFeaturedWorkData = data.tsPage.flexibleContent.flexibleContent[5];

  return { KotlinFeaturedWorkData };
};
