...
export const useMagentoCoreSpecialtiesQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryMagentoCoreSpecialtiesSection {
  ...
  const MagentoCoreSpecialtiesData =
    data.tsPage.flexibleContent.flexibleContent[4];

  return { MagentoCoreSpecialtiesData };
};
