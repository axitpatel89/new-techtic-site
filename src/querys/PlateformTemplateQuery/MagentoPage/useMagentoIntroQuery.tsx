...
export const useMagentoIntroQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryMagentoBannerSection {
  ...
  const MagentoIntroData = data.tsPage.flexibleContent.flexibleContent[0];

  return { MagentoIntroData };
};
