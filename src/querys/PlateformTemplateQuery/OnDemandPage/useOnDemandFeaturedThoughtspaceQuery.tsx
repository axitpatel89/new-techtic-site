...
export const useOnDemandFeaturedThoughtspaceQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryOnDemandFeaturedThoughtspaceSection {
  ...
  const OnDemandThoughtspaceData =
    data.tsPage.flexibleContent.flexibleContent[7];

  return {
    OnDemandThoughtspaceData,
  };
};
