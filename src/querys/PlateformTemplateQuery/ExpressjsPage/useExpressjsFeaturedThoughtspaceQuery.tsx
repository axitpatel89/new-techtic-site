...
export const useExpressjsFeaturedThoughtspaceQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryExpressjsFeaturedThoughtspaceSection {
  ...
  const ExpressjsThoughtspaceData =
    data.tsPage.flexibleContent.flexibleContent[7];

  return {
    ExpressjsThoughtspaceData,
  };
};
