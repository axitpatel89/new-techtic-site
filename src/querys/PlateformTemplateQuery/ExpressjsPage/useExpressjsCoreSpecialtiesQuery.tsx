...
export const useExpressjsCoreSpecialtiesQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryExpressjsCoreSpecialtiesSection {
  ...
  const ExpressjsCoreSpecialtiesData =
    data.tsPage.flexibleContent.flexibleContent[4];

  return { ExpressjsCoreSpecialtiesData };
};
