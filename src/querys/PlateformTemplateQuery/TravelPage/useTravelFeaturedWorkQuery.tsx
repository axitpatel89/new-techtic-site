...
export const useTravelFeaturedWorkQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryTravelFeaturedWorkSection {
  ...
  const TravelFeaturedWorkData = data.tsPage.flexibleContent.flexibleContent[5];

  return { TravelFeaturedWorkData };
};
