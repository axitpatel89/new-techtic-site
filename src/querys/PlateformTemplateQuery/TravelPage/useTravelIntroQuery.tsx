...
export const useTravelIntroQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryTravelBannerSection {
  ...
  const TravelIntroData = data.tsPage.flexibleContent.flexibleContent[0];

  return { TravelIntroData };
};
