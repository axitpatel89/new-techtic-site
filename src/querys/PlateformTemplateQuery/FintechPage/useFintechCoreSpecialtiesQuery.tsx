...
export const useFintechCoreSpecialtiesQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryFintechCoreSpecialtiesSection {
  ...
  const FintechCoreSpecialtiesData =
    data.tsPage.flexibleContent.flexibleContent[4];

  return { FintechCoreSpecialtiesData };
};
