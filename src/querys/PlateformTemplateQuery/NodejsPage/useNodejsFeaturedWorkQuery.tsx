...
export const useNodejsFeaturedWorkQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryNodejsFeaturedWorkSection {
  ...
  const NodejsFeaturedWorkData = data.tsPage.flexibleContent.flexibleContent[5];

  return { NodejsFeaturedWorkData };
};
