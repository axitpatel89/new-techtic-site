...
export const useNodejsWhyUsQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryNodejsWhyUsSection {
  ...
  const NodejsWhayUsData = data.tsPage.flexibleContent.flexibleContent[2];

  return { NodejsWhayUsData };
};
