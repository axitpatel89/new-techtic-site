...
export const useWordPressCoreSpecialtiesQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryWordPressCoreSpecialtiesSection {
  ...
  const WordPressCoreSpecialtiesData =
    data.tsPage.flexibleContent.flexibleContent[4];

  return { WordPressCoreSpecialtiesData };
};
