...
export const useWordPressIntroQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryWordPressBannerSection {
  ...
  const WordPressIntroData = data.tsPage.flexibleContent.flexibleContent[0];

  return { WordPressIntroData };
};
