...
export const useAngularCoreSpecialtiesQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryAngularCoreSpecialtiesSection {
  ...
  const AngularCoreSpecialtiesData =
    data.tsPage.flexibleContent.flexibleContent[4];

  return { AngularCoreSpecialtiesData };
};
