...
export const useIonicFeaturedWorkQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryIonicFeaturedWorkSection {
  ...
  const IonicFeaturedWorkData = data.tsPage.flexibleContent.flexibleContent[5];

  return { IonicFeaturedWorkData };
};
