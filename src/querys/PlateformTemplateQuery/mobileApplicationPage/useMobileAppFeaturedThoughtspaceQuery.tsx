...
export const useMobileAppFeaturedThoughtspaceQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryMobileAppFeaturedThoughtspaceSection {
  ...
  const MobileAppThoughtspaceData =
    data.tsPage.flexibleContent.flexibleContent[7];

  return {
    MobileAppThoughtspaceData,
  };
};
