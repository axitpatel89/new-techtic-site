...
export const useMobileAppWhyUsQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryMobileAppWhyUsSection {
  ...
  const MobileAppWhayUsData = data.tsPage.flexibleContent.flexibleContent[2];

  return { MobileAppWhayUsData };
};
