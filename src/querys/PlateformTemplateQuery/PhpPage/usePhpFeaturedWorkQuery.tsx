...
export const usePhpFeaturedWorkQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryPhpFeaturedWorkSection {
  ...
  const PhpFeaturedWorkData = data.tsPage.flexibleContent.flexibleContent[5];

  return { PhpFeaturedWorkData };
};
