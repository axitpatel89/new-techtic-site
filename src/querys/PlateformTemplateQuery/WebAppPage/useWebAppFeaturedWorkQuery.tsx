...
export const useWebAppFeaturedWorkQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryWebAppFeaturedWorkSection {
  ...
  const WebAppFeaturedWorkData = data.tsPage.flexibleContent.flexibleContent[5];

  return { WebAppFeaturedWorkData };
};
