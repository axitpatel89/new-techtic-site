...
export const useReactNativeFeaturedWorkQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryReactNativeFeaturedWorkSection {
  ...
  const ReactNativeFeaturedWorkData =
    data.tsPage.flexibleContent.flexibleContent[5];

  return { ReactNativeFeaturedWorkData };
};
