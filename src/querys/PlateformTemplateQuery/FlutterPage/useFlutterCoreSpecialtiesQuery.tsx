...
export const useFlutterCoreSpecialtiesQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryFlutterCoreSpecialtiesSection {
  ...
  const FlutterCoreSpecialtiesData =
    data.tsPage.flexibleContent.flexibleContent[4];

  return { FlutterCoreSpecialtiesData };
};
