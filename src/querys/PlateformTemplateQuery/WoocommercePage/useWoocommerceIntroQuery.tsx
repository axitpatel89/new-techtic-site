...
export const useWoocommerceIntroQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryWoocommerceBannerSection {
  ...
  const WoocommerceIntroData = data.tsPage.flexibleContent.flexibleContent[0];

  return { WoocommerceIntroData };
};
