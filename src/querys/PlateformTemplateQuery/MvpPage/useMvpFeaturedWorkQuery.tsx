...
export const useMvpFeaturedWorkQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryMvpFeaturedWorkSection {
  ...
  const MvpFeaturedWorkData = data.tsPage.flexibleContent.flexibleContent[5];

  return { MvpFeaturedWorkData };
};
