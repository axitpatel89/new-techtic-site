...
export const useShopwareFeaturedThoughtspaceQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryShopwareFeaturedThoughtspaceSection {
  ...
  const ShopwareThoughtspaceData =
    data.tsPage.flexibleContent.flexibleContent[7];

  return {
    ShopwareThoughtspaceData,
  };
};
