...
export const useShopwareWhyUsQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryShopwareWhyUsSection {
  ...
  const ShopwareWhayUsData = data.tsPage.flexibleContent.flexibleContent[2];

  return { ShopwareWhayUsData };
};
