...
export const useShopwareIntroQuery = () => {
  const data: {
    tsPage: {
      flexibleContent: {
        flexibleContent: {
    ...
    graphql`
      query MyQueryShopwareBannerSection {
  ...
  const ShopwareIntroData = data.tsPage.flexibleContent.flexibleContent[0];

  return { ShopwareIntroData };
};
